...
const PinDetails = ({ user }) => {
    ...
    return (
        <>
            <div className='flex xl:flex-row flex-col bg-white' style={{maxWidth:'1500px', borderRadius:'32px'}}>
                ...
                <div className='w-full p-5 flex-1 xl:min-w-620'>
                    ...
                    <div className='flex flex-wrap mt-6 gap-3 items-center'>
                        ...
                        <button 
                            type="button"
                            className='bg-main text-white rounded-full px-6 py-2 font-semibold text-base outline-none'
                            onClick={addComment}
                        >
                            {addingComment 
                                ? 'Posting the comment...'
